...
public class TomatoProgressThreeColorsView: UIView {
	var myView = UIView()
	...
	public func rotateMe() {
		if !isDegreesValid(startDegree0: startDegree0, endDegree0: endDegree0, startDegree1: startDegree1, endDegree1: endDegree1, startDegree2: startDegree2, endDegree2: endDegree2) {
			return
		}
	...
	func isDegreesValid(startDegree0: CGFloat, endDegree0: CGFloat, startDegree1: CGFloat, endDegree1: CGFloat, startDegree2: CGFloat, endDegree2: CGFloat) -> Bool {
		let sum0 = abs(startDegree0 - endDegree0)
		let sum1 = abs(startDegree1 - endDegree1)
		let sum2 = abs(startDegree2 - endDegree2)
		if sum0 + sum1 + sum2 == CGFloat(360.0) {
			if endDegree0 == startDegree1 && endDegree1 == startDegree2 {
				if abs(startDegree0 - endDegree2) == CGFloat(360.0) {
					return true
				} else {
					Swift.print("Wrong degrees!")
					return false
				}
			} else {
				Swift.print("Wrong degrees!")
